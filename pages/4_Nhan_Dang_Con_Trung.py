...
image_file = st.file_uploader("Tải ảnh lên", type=["bmp", "png", "jpg", "jpeg"], key="file_uploader")
if image_file is not None:
    ...
    if st.button('Dự đoán'):
        result_frame = predict(frame)
        st.image(result_frame, caption="Kết quả dự đoán", channels="BGR")
